...
app.post('/3d', async (req, res) => {
    try {
        ...
        const slicerCommand = `./prusaslicer/prusa-slicer --load-settings "${machinePath};${processPath}" --load-filaments "${filamentPath}" --curr-bed-type "Textured PEI Plate" --slice 0 --export-3mf ${outFilePath} ${filePath}`;
